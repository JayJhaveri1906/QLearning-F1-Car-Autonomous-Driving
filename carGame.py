...
BG = pygame.image.load("assets/bg_lava.png")
BG = scale_image(BG, 1.5) # resizing shiz to fit

TRACK = pygame.image.load("assets/track_600.png")
TRACK_OL = pygame.image.load("assets/track_outline_600.png")
